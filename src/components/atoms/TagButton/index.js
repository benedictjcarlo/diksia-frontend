...
const TagButton = ({text,bgColor='#FFF', color='#8A8A8A', brWidth, brColor, width, fontSize=12, fontWeight='bold', onSelect}) => {
  return (
    <TouchableOpacity activeOpacity={0.8} onPress={() => onSelect(text)}>
